        ...
        <main class="main">
            ...
            <div id="popup51-jadwal" class="popup51-jadwal-container">
                <div class="popup51-jadwal-content">
                    <button class="close51-popup-btn" onclick="closePopup('popup51-jadwal')">✖</button>
                    <h2>Memasuki arena sidang proposal</h2>
                    <p>Tiba saatnya memasuki arena ujian. Para Penjaga Akademik telah menunggu, dan proposalmu akan diuji dalam cahaya logika dan badai pertanyaan. Siapkan keberanian, ini adalah langkah penting menuju pengakuan.</p>

                    <label for="judulProposal">Judul Skripsi Anda</label>
                    <input type="text" id="judulProposal" placeholder="Isi judul skripsi anda" />

                    <label for="jadwalProposal">Jadwal Seminar Proposal</label>
                    <select id="jadwalProposal">
                        <option value="">--- jadwal ---</option>
                        <option value="UTS">UTS</option>
                        <option value="UAS">UAS</option>
                    </select>

                    <label for="linkProposal">Link Proposal Skripsi Anda</label>
                    <input type="text" id="linkProposal" placeholder="Masukkan link Google Drive atau URL lainnya" />
            ...
            <div id="popup52-submit" class="popup52-submit-container">
                <div class="popup52-submit-content">
                    <button class="close52-popup" onclick="closePopup('popup52-submit')">✖</button>
                    <div class="popup52-judul-content">
                        <h2>Unggah Bukti Seminar Proposal</h2>
                        <p>Unggah bukti pelaksanaan Seminar Proposal sebagai tanda telah menyelesaikan quest ini.</p>
                        <label for="linkBuktiProposal">Link Bukti Pelaksanaan</label>
                        <input type="text" id="linkBuktiProposal" placeholder="Masukkan link foto atau dokumen bukti"/>
                        <button id="submit52-submit" class="submit52-submit-btn">Kirim</button>
                    </div>
                </div>
            </div>
            ...
            <div id="popup101-jadwal" class="popup101-jadwal-container">
                <div class="popup101-jadwal-content">
                    <button class="close101-popup-btn" onclick="closePopup('popup101-jadwal')">✖</button>
                    <h2>Tantang ruang pengujian terakhir</h2>
                    <p>Lingkaran Penguji telah terbentuk. Di sinilah segala hal yang kau pelajari diuji dalam pertempuran intelektual. Hadapi mereka dengan penuh keyakinan. Kini saatnya membuktikan bahwa kau layak menjadi Sarjana Arcanum.</p>
                    <label for="judulSkripsi">Judul Skripsi Anda</label>
                    <input type="text" id="judulSkripsi" placeholder="Isi judul skripsi anda"/>
                    ...
                    <label for="linkSkripsiFinal">Link Skripsi Final Anda</label>
                    <input type="text" id="linkSkripsiFinal" placeholder="Masukkan link Google Drive atau URL lainnya"/>
            ...
            <div id="popup102-submit" class="popup102-submit-container">
                <div class="popup102-submit-content">
                    <button class="close102-popup" onclick="closePopup('popup102-submit')">✖</button>
                    <div class="popup102-judul-content">
                        <h2>Sidang suci arcana</h2>
                        <p>Unggah hasil revisi skripsi final</p>
                        <label for="linkRevisiFinal">Link Revisi Final</label>
                        <input type="text" id="linkRevisiFinal" placeholder="Masukkan link Google Drive atau URL lainnya"/>
                        <button id="submit102-submit" class="submit102-submit-btn">Kirim</button>
                    </div>
                </div>
            </div>

            <div id="quest-alert101" class="quest-alert101">
                <p>Jadwal telah ditetapkan, silahkan persiapkan diri untuk seminar hasil di jadwal tersebut.</p>
            </div>
            ...
            <div id="popup-level12" class="popup12-container">
                <div class="popup12-content">
                    <button class="close12-popup" onclick="closePopup('popup-level12')">✖</button>
                    ...
                    <div class="popup12-character">
                        ...
                        <div class="popup12-info">
                            ...
                            <p>Dengan semua ritus terlampaui, satu langkah terakhir menunggumu. Mengukuhkan gelar dan menerima mahkota kebanggaan. Saat jubah kebesaran disematkan dan namamu dipanggil, Akademia Arcana mengenangmu sebagai legenda baru dalam sejarahnya.</p>
            ...
            <div id="popup121-jadwal" class="popup121-jadwal-container">
                <div class="popup121-jadwal-content">
                    <button class="close121-popup-btn" onclick="closePopup('popup121-jadwal')">✖</button>
                    <h2>Kunci akhir ritus akademik</h2>
                    <p>Langkahkan kakimu menuju upacara agung. Klik di sini untuk mengunci ritus terakhir dan daftarkan dirimu dalam sejarah Akademia!</p>
                    <label for="judul 1">Judul Skripsi Anda</label>
                    <input type="text" id="alasan1" placeholder="Isi judul skripsi anda"/>
                    ...
                    <label for="linkSkripsi">Link Skripsi Final</label>
                    <input type="text" id="linkSkripsi" placeholder="Masukkan link Google Drive atau URL lainnya" />

                    <label for="linkLampiran">Link Lampiran Pendukung</label>
                    <input type="text" id="linkLampiran" placeholder="Masukkan link atau catatan untuk lampiran" />

                    <button id="submit121-jadwal" class="submit121-btn">Kirim</button>
                </div>
            </div>
            <div id="quest-overlay" class="quest-overlay">
                <img src={{ asset('images/Peta/Ending.png') }} alt="Notifikasi" id="quest-img" class="quest-img"/>
            </div>
        </main>
        </div>
